...
Discussion of this work occurs on the [Operationalizing Network &amp; SErvice abstractioNs
Working Group mailing list](mailto:onions@ietf.org)
([archive](https://mailarchive.ietf.org/arch/browse/onions/),
[subscribe](https://mailman3.ietf.org/mailman3/lists/onions.ietf.org/)).
...
[Working Group documents](https://datatracker.ietf.org/wg/onsen/documents/).
